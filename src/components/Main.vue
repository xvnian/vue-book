          ...
          >
            <div v-bind:style="{width: width+'px'}">
              ...
              <div class="Pull-scroll">
                <div class="wrap">
                  <div
                    class="new-page channel-page"
                    id="Tag__2"
                  >
                    <section class="top-home">
                      <div
                        class="top-home__search"
                        @click="$router.push({ path: '/search' })"
                      >输入书名/作者/关键字</div>
                      <div
                        class="Swipe slider-banner"
                        data-track="s"
                        id="Tag__3"
                        data-dom-uid="4"
                        data-dom-del="1"
                      >
                        <div style="width: 100%; transform: translate3d(0px, 0px, 0px); transition-duration: 0s;">
                          <div
                            class="u-topic"
                            data-href="#page=topic&amp;type=fiction&amp;id=11439"
                            data-track="0"
                            expose=""
                            da="index.0.sld.0"
                            style="width: 100%;"
                          >
                            <div class="banner"><img
                                class="cover"
                                src="http://image.read.duokan.com/mfsv2/download/fdsc3/p01qDSHWUGqf/DoSt6VIaNe0oC2.jpg"
                              ></div>
                          </div>
                        </div>
                      </div>
                      <ul class="top-home__btn">
                        <li
                          @click="channel(371)"
                          data-href="#page=channel&amp;id=371"
                          data-title="免费"
                        ><img
                            class="top-home__icon"
                            src="http://image.read.duokan.com/mfsv2/download/s010/p015iBxwdkmU/5wc5uzYhLZ7iVa.png"
                          >
                          <p class="top-home__des">免费</p>
                        </li>
                        <li
                          @click="channel(370)"
                          data-href="#page=channel&amp;id=370"
                          data-title="女生"
                        ><img
                            class="top-home__icon"
                            src="http://image.read.duokan.com/mfsv2/download/s010/p01LWZmXGCpy/aSrSq6Llgt9PqE.png"
                          >
                          <p class="top-home__des">女生</p>
                        </li>
                        <li
                          @click="channel(369)"
                          data-href="#page=channel&amp;id=369"
                          data-title="男生"
                        ><img
                            class="top-home__icon"
                            src="http://image.read.duokan.com/mfsv2/download/s010/p01lq7mbkaEJ/OGlv1em8buXDgB.png"
                          >
                          <p class="top-home__des">男生</p>
                        </li>
                        <li
                          @click="channel(371)"
                          data-href="/hs/market/cate"
                          data-title="分类"
                        ><img
                            class="top-home__icon"
                            src="http://image.read.duokan.com/mfsv2/download/s010/p01pz5NtyRI0/2ENONnvOg23NXM.png"
                          >
                          <p class="top-home__des">分类</p>
                        </li>
                        <li
                          @click="channel(371)"
                          data-href="/hs/market/rank"
                          data-title="排行"
                        ><img
                            class="top-home__icon"
                            src="http://image.read.duokan.com/mfsv2/download/s010/p010kK7M5VyH/8kPz9nKvRXyu1k.png"
                          >
                    ...
                    <section class="channel-group main-card">
                      <div class="channel-group__header">
                        <h2 class="channel-group__title channel-group__title_left">本周最火</h2>
                      </div>
                      <ul class="book-table">
                        <li
                          v-for='item in hotData'
                          @click="book(item.fiction_id)"
                        >
                          <div class="u-book -vertical">
                            <div class="book-cover Lazy_loading Lazy_loaded"><img
                                :alt="item.title"
                                v-lazy="item.cover+'!s'"
                              >
                    ...
                    <section
                      class="channel-h5 channel-h5_tab"
                      id="Tag__10"
                    >
                      ...
                      <div class="tab__bd">
                        <div class="tab__wrap">
                          ...
                          <div class="channel-h5__footer_next"><a
                              @click="changeRecommend"
                              class="btn-h5__next"
                              href="javascript:"
                            >换一换</a><a class="btn-h5__more">查看全部</a></div>
                        </div>
                        <div
                          class="tab__wrap"
                          style="display:none"
                            ...
                            <div style="visibility: visible;">
                              <ul class="list-h5">
                                <li>
                                  <div
                                    class="book-h5"
                                    data-href="#page=book&amp;source_id=24524&amp;source=2"
                                    da="index.2.b.15*2_24524"
                                    expose=""
                                  >
                                    <div
                                      class="book-h5__cover Lazy_loading"
                                      data-id="24524"
                                      id="Tag__15"
                                    ><img alt="天价前妻">
                                      <div class="u-tagRT"></div>
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=348083&amp;source=2"
                                    da="index.2.b.16*2_348083"
                                    expose=""
                                  ><span class="book-h5_no-img__order">02</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=318724&amp;source=2"
                                    da="index.2.b.17*2_318724"
                                    expose=""
                                  ><span class="book-h5_no-img__order">03</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=352615&amp;source=2"
                                    da="index.2.b.18*2_352615"
                                    expose=""
                                  ><span class="book-h5_no-img__order">04</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=318609&amp;source=2"
                                    da="index.2.b.19*2_318609"
                                    expose=""
                                  ><span class="book-h5_no-img__order">05</span>
                                    <div class="book-h5_no-img__info">
                            ...
                            <div>
                              <ul class="list-h5">
                                <li>
                                  <div
                                    class="book-h5"
                                    data-href="#page=book&amp;source_id=349380&amp;source=2"
                                    da="index.2.b.20*2_349380"
                                    expose=""
                                  >
                                    <div
                                      class="book-h5__cover Lazy_loading"
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=316243&amp;source=2"
                                    da="index.2.b.21*2_316243"
                                    expose=""
                                  ><span class="book-h5_no-img__order">02</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=317703&amp;source=2"
                                    da="index.2.b.22*2_317703"
                                    expose=""
                                  ><span class="book-h5_no-img__order">03</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=45104&amp;source=2"
                                    da="index.2.b.23*2_45104"
                                    expose=""
                                  ><span class="book-h5_no-img__order">04</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=316343&amp;source=2"
                                    da="index.2.b.24*2_316343"
                                    expose=""
                                  ><span class="book-h5_no-img__order">05</span>
                                    <div class="book-h5_no-img__info">
                            ...
                            <div>
                              <ul class="list-h5">
                                <li>
                                  <div
                                    class="book-h5"
                                    data-href="#page=book&amp;source_id=45031&amp;source=2"
                                    da="index.2.b.25*2_45031"
                                    expose=""
                                  >
                                    <div
                                      class="book-h5__cover Lazy_loading"
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=348027&amp;source=2"
                                    da="index.2.b.26*2_348027"
                                    expose=""
                                  ><span class="book-h5_no-img__order">02</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=351278&amp;source=2"
                                    da="index.2.b.27*2_351278"
                                    expose=""
                                  ><span class="book-h5_no-img__order">03</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=348004&amp;source=2"
                                    da="index.2.b.28*2_348004"
                                    expose=""
                                  ><span class="book-h5_no-img__order">04</span>
                                    <div class="book-h5_no-img__info">
                                ...
                                <li>
                                  <div
                                    class="book-h5 book-h5_no-img"
                                    data-href="#page=book&amp;source_id=280963&amp;source=2"
                                    da="index.2.b.29*2_280963"
                                    expose=""
                                  ><span class="book-h5_no-img__order">05</span>
                                    <div class="book-h5_no-img__info">
                    ...
                    <section
                      class="channel-h5 channel-h5_next"
                      id="Tag__19"
                    >
                      <div class="channel-h5__header">
                      ...
                      >
                        <div style="visibility: visible;">
                          <ul class="list-h5">
                            ...
                            >
                              <div class="book-h5">
                                <div class="book-h5__cover "><img
                                    v-lazy="item.cover"
                                    :alt="item.title"
                                  >
                                  <div class="u-tagRT"></div>
                                  <p
                                    class="book-h5__finish"
                                    v-if="item.finish"
                                  >完结</p>
                                </div>
                                <div class="book-h5__info">
                    ...
                    <section class="channel-group main-card">
                      ...
                      <ul class="book-table">
                        <li
                          v-for="item in freeData"
                          @click="book(item.reference_id)"
                        >
                          <div class="u-book -vertical">
            ...
            <div v-bind:style="{width: width+'px'}">
              ...
              <div class="new-page shelf">
                <div class="shelf__top">
                  <div
                    class="shelf__switch shelf__switch_list"
                    @click="shelfList=!shelfList"
                  ></div>
                  <div
                    class="shelf-search"
                    @click="$router.push({ path: '/search' })"
...
export default {
  ...
  created: function() {
    ...
    if (this.hotData.length === 0) {
      this.$http.jsonp(window.config.url + "/php/bookapi/index.php").then(
        response => {
    ...
    if (this.bookrackData.length === 0) {
      this.$http.jsonp(window.config.url + "/php/bookapi/bookrack.php").then(
        response => {
